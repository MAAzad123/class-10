                ...
                <div class="col-lg-5 mx-auto">
                    ...
                    <form action="./controllers/createController.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input name="title" type="text" class="form-control" placeholder="Enter Your Post Title">
                            <p class="text-danger">
                                <?php
                        ...
                        <div class="mb-3">
                            ...
                            <input name="author" type="text" class="form-control" placeholder="Enter Your Author Name">
                            <p class="text-danger">
                                <?php
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" type="text" class="form-control" placeholder="Enter Your Post Description"></textarea>
                            <p class="text-danger">
                                <?php
